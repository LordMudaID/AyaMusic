...
from AyaMusic.utils.database import get_lang, set_lang
from AyaMusic.utils.decorators import (ActualAdminCB, language,
                                         languageCB)
...
def lanuages_keyboard(_):
    ...
    keyboard.row(
        InlineKeyboardButton(text="𝐈𝐧𝐝𝐨𝐧𝐞𝐬𝐢𝐚", callback_data=f"languages:toxic"),
    )
    keyboard.row(
        InlineKeyboardButton(text="𝐓𝐨𝐱𝐢𝐜", callback_data=f"languages:id"),
    )
    keyboard.row(
